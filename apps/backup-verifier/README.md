...
Source code for the **Backup Verifier** UGOS Docker application. Install via UGREEN App
Center after official listing, or build the Docker image from this directory.

## Build

```bash
docker build -t runlevel/backup-verifier:local .
```
...
- [User guide](../../docs/help/backupverifier.md)
- [Help index](../../docs/help/README.md)
- [Privacy policy](../../docs/privacy/backupverifier.md)
