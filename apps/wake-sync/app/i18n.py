...
STRINGS: dict[str, dict[str, str]] = {
    "de": {
        ...
        "plan.enabled": "Aktiv",
        "plan.smb_performance": "SMB Performance-Modus (schneller, bei Fehlern automatisch stabil)",
        "plan.smb_performance_hint": "Aktiviert rclone Multi-Thread/SMB-Chunk-Writes zum Ziel-NAS. Kann auf manchen Windows/QNAP-Zielen scheitern — dann Fallback auf stabilen Modus.",
        "plan.mode_perf": "SMB Performance",
        ...
        "plan.running": "Läuft…",
        "plan.stop": "Stoppen",
        "plan.stopping": "Wird gestoppt…",
        "plan.stop_requested": "Stopp angefordert",
        "plan.cancelled": "Abgebrochen.",
        ...
        "plan.status_cancelled": "Abgebrochen",
        "jobs.active_title": "Aktive Jobs",
        "jobs.none": "Keine laufenden Jobs.",
        "jobs.running": "Läuft",
        "jobs.done": "Fertig",
        "jobs.failed": "Fehler",
        "jobs.cancelled": "Abgebrochen",
        "jobs.stop": "Stoppen",
        "jobs.phase.wol": "Wake-on-LAN…",
        "jobs.phase.wait": "Warte auf Ziel-NAS…",
        "jobs.phase.sync": "Synchronisiere",
        ...
        "job.pick_multi_hint": "Mehrere Ordner: Häkchen setzen → „Markierte übernehmen“. Pro Ordner ein eigener Sync-Lauf (nur geänderte Dateien).",
        "job.pick_add_checked": "Markierte übernehmen",
        "job.pick_replace_here": "Nur diesen Ordner",
        "job.selected_folders": "Ausgewählte Quellordner",
        "job.sync_incremental_hint": "Übertragung per rclone sync — es werden nur neue/geänderte Dateien kopiert, nicht jedes Mal alles.",
        "endpoint.multi_local": "{name} · {count} Ordner ({paths})",
        "err.pick_source_folders": "Mindestens einen Quellordner wählen",
        "err.whole_volume_single": "Ganzes Volume nur allein — nicht zusammen mit weiteren Ordnern",
        ...
        "err.plan_not_running": "Job läuft nicht",
    ...
    "en": {
        ...
        "plan.smb_performance": "SMB performance mode (faster, auto-fallback to stable on errors)",
        "plan.smb_performance_hint": "Enables rclone multi-thread/SMB chunk writes to the target NAS. May fail on some Windows/QNAP targets — then falls back to stable mode.",
        "plan.mode_perf": "SMB performance",
        ...
        "plan.stop_requested": "Stop requested",
        ...
        "plan.status_cancelled": "Cancelled",
        "jobs.active_title": "Active jobs",
        "jobs.none": "No running jobs.",
        ...
        "jobs.stop": "Stop",
        "jobs.phase.wol": "Wake-on-LAN…",
        "jobs.phase.wait": "Waiting for target NAS…",
        "jobs.phase.sync": "Syncing",
        ...
        "job.pick_multi_hint": "Multiple folders: check boxes → “Add checked”. Each folder runs its own sync (changed files only).",
        "job.pick_add_checked": "Add checked",
        "job.pick_replace_here": "This folder only",
        "job.selected_folders": "Selected source folders",
        "job.sync_incremental_hint": "Uses rclone sync — only new/changed files are transferred, not the full tree every time.",
        "endpoint.multi_local": "{name} · {count} folders ({paths})",
        "err.pick_source_folders": "Select at least one source folder",
        "err.whole_volume_single": "Whole volume cannot be combined with other folders",
        "volume.usb_name_fmt": "USB: {name}",
        ...
        "err.plan_not_running": "Job is not running",
...
def resolve_lang() -> str:
    """Alias used by job modules (Transfer Hub naming)."""
    return get_lang()
