...
Source code for the **Stats Hub** UGOS Docker application. Install via UGREEN App
Center after official listing, or build the Docker image from this directory.

## Build

```bash
docker build -t runlevel/stats-hub:local .
```
...
- [User guide](../../docs/help/statshub.md)
- [Help index](../../docs/help/README.md)
- [Privacy policy](../../docs/privacy/statshub.md)
